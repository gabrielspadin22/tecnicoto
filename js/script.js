let sucursales = [
    ...
    {numeroSuc:204,dir:"Lavalle no me acuerdo jaja :c"},
    ...
    {numeroSuc:235,dir:"Qilmes y que mas????"},
    {numeroSuc:512,dir:"COTO pañol base 12"},
]
        ...
        for( let i=0; i < sucursales.length; i++){
            ...
            if(numerosSuc == input){
                for (let index = 0; index < clase.length; index++) {
                    clase[index].classList.toggle('display')     
                }
